...
| 버전 | 날짜 | 내용 |
|---|---|---|
| **2.5.5** | 2026-06-13 | 다분야 전문가 최종 감사 — 보안(RLS+XSS 전수: 모든 사용자데이터 esc() 확인)·회계(역산·0나누기 방어 parseQty≥1)·접근성·신뢰성·모바일 점검 통과. 실개선: 노치폰 하단 safe-area 여백(viewport-fit=cover 보완) |
