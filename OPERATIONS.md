...
> **마지막 업데이트**: 2026-05-26 (자동 봇 안정화 + 인라인 편집 픽스)
...
## 2. ⏰ 자동 실행 스케줄 (최종 — 2026-05-26)

모두 **KST 기준 (UTC+9)**. 평일만.

| 시간 (KST) | 봇 | 무엇 |
|---|---|---|
| **08:00** | 🤖 선반랙 + 🛒 카트 발주 (1차) | 새벽·아침 모인 거 |
| **12:00** | 🤖 선반랙 + 🛒 카트 발주 (2차) | 점심 직전 |
| **12:30** | 🤖 선반랙 + 🛒 카트 발주 (3차) | 점심 직전 |
| **12:35** | 📲 푸시 알림 | 발주 마감 임박 |
| **12:51** | 🤖 선반랙 + 🛒 카트 발주 (4차, 마지막) | 12:55 마감 직전 |
| **16:02** | 🚚 송장 수집 (1차) | OMS + 카트 |
| **17:02** | 🚚 송장 수집 (2차, 마지막) | OMS + 카트 |
| 매일 **10:00** | 🚨 72H 미입금 알림 | 입력자에게 푸시 |
| 매월 1일 **02:00 KST** | 💾 DB 백업 | bot/backups/YYYY-MM.csv |

ℹ️ GitHub Actions cron은 UTC 기반이라 코드엔 UTC로 적혀있음. cron 분(分)은 정시 :00 대신 :02로 살짝 offset — GH 정시 트래픽 지연 회피용.
...
**마지막 commit**: `9789d92` 종합 점검 픽스 — 인라인편집·카트봇·알람·푸시 정확성
